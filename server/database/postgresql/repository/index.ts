...
import type { CommonRecord, User } from '~/server/database/postgresql/schema';
import { users } from '~/server/database/postgresql/schema';
import { APIError } from '~/types/common';
import type { SearchQuery, SortByEnum } from '~/types/common/zod';
import { arrayInclude, tryCatchHandler, DEFAULT_LIMIT, sortByMap } from '~/utils';
...
const getListRecord = async <TRecord extends CommonRecord>(
	...
	const { data, isSuccess, error } = await tryCatchHandler(query);
