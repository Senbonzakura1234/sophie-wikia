...
import * as schema from '~/server/database/postgresql/schema';
import type { ExportDBQueriesMap } from '~/types/model';
...
const connection = neon<boolean, boolean>(appEnv.PGURL_NONPOOLING);
